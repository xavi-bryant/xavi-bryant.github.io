...
Carousel.prototype = {
  ...
  changeZindex_add: function() {
    var imgNum = $(".transverse-box").find(".img-item").length;
    var lastZindex = $(".transverse-box")
      .find(".img-item")
      .eq(length - 1)
      .attr("zindex");
    var firstImg = $(".transverse-box")
      .find(".img-item")
      .eq(0)
      .find("img");
    ...
    $(".transverse-box")
      ...
      .remove();
    $(".transverse-box").append(
      "<div class='img-item' zindex='" +
        (parseInt(lastZindex) + 1) +
        "'><a href='" +
        firstImgUrl +
        "' target='_blank'><img src='" +
        firstImgSrc +
    ...
    $(".vertical-box ul")
      ...
      .eq(0)
      .find("a")
      .attr("href", lastImgUrl);
    $(".vertical-box ul")
      .find("li")
      .eq(1)
      .find("img")
      .attr("src", last2ImgSrc);
    $(".vertical-box ul")
      .find("li")
      .eq(1)
      .find("a")
      .attr("href", last2ImgUrl);
    $(".transverse-box")
      .find(".img-item")
      .eq(length - 1)
      .css(
  ...
  changeZindex_sub: function() {
    ...
    var lastZindex = $(".transverse-box")
      ...
      .eq(length - 1)
      .attr("zindex");
    var firstZindex = $(".transverse-box")
      .find(".img-item")
      .eq(0)
      .attr("zindex");
    var lastImg = $(".transverse-box")
      .find(".img-item")
      .eq(length - 1)
      .find("img");
    ...
    $(".transverse-box")
      ...
      .eq(length - 1)
      .remove();
    $(".transverse-box").prepend(
      "<div class='img-item' zindex='" +
        (parseInt(firstZindex) - 1) +
        "'><a href='" +
        lastImgUrl +
        "' target='_blank'><img src='" +
        lastImgSrc +
    ...
    $(".vertical-box ul")
      ...
      .eq(0)
      .find("a")
      .attr("href", firstImgUrl);
    $(".vertical-box ul")
      .find("li")
      .eq(1)
      .find("img")
      .attr("src", first2ImgSrc);
    $(".vertical-box ul")
      .find("li")
      .eq(1)
      .find("a")
      .attr("href", first2ImgUrl);
    $(".transverse-box")
      .find(".img-item")
      .eq(0)
      .css({
